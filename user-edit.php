        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4>Edit & Update User Data <a href="user-list.php" class="btn btn-danger float-end">BACK</a></h4>
                </div>
                <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            try {
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button type="submit" name="enable_disable_user_acc" class="input-group-text btn btn-primary">Submit</button>
                                </div>
                                <?php
                            } catch (\Kreait\Firebase\Exception\Auth\UserNotFound $e) {
                                echo $e->getMessage();
                    ...
                    <form action="code.php" method="POST">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            try {
                                ...
                                <div class="form-group mb-3">
                                    <button type="submit" name="change_password_btn" class="btn btn-success">Submit</button>
                                </div>
                                <?php
                            } catch (\Kreait\Firebase\Exception\Auth\UserNotFound $e) {
                                echo $e->getMessage();
